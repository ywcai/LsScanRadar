...
public class LsRadarScanView extends View {
    ...
    public LsRadarScanView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
        initAttribute(context, attrs);
    }

    public LsRadarScanView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            startScan();
     ...
     */
    public LsRadarScanView setRadarBackgroundLinesNumber(int number) {
     ...
     * @return RadarScanView
     */
    public LsRadarScanView setRadarBackgroundLinesWidth(float width) {
     ...
     * @return RadarScanView
     */
    public LsRadarScanView setRadarBackgroundLinesColor(int color) {
     ...
     * @return RadarScanView
     */
    public LsRadarScanView setRadarBackgroundColor(int color) {
     ...
     * @return RadarScanView
     */
    public LsRadarScanView setRadarScanColor(int endColor) {
     ...
     * @return RadarScanView
     */
    public LsRadarScanView setRadarScanColors(int startColor, int endColor) {
...
//    }
     ...
     * @return RadarScanView
     */
    public LsRadarScanView setRadarScanAlpha(int alpha) {
     ...
     */
    public LsRadarScanView setRadarScanTime(int milliseconds) {
        if (0 < milliseconds) {
